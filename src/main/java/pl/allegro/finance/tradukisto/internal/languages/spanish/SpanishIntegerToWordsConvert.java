...
public class SpanishIntegerToWordsConvert extends IntegerToWordsConverter {

        private final Map<Integer, String> exceptions;
    
        public SpanishIntegerToWordsConvert(
        ...
        private String getThousandsAsWords(Integer thousands, Integer other) {
            ...
            return format("%s MIL %s", asWords(thousands), asWords(other));
        }
    
        private String getOneThousandAsWords(Integer other) {
            return format("MIL %s", asWords(other));
        }
